...
public class PageNavigationCallback extends AbstractNavigationCallback
{
	...
	{
		if (page.getClass()==_page) return true;
		return false;
	}
	...
	public static boolean replaceCallback(List<NavigationCallbackInterface> ret,Class<? extends Page> page,NavigationCallbackInterface callback)
	{
