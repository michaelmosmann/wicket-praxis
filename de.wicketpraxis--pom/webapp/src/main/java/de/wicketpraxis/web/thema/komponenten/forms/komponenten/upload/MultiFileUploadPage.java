...
public class MultiFileUploadPage extends AbstractFormPage
{
	...
	{
		final MultiFileUploadField fileUploadField = new MultiFileUploadField("Upload",new CollectionModel<FileUpload>(new ArrayList<FileUpload>()),5);
		...
		Form<Void> form=new Form<Void>("form")
		{
			...
			protected void onSubmit()
			{
				...
				{
					info(MessageFormat.format("Filename: {0}, Size: {1}, MimeType: {2}", upload.getClientFileName(), upload.getSize(),upload.getContentType()));
				}
			}
		};
