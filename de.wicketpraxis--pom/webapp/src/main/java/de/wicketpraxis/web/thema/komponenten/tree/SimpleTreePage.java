...
public class SimpleTreePage extends WebPage
{
	...
	{
		add(new SimpleTreePanel("root")
			.setLeft(new SimpleTreePanel(SimpleTreePanel.LEFT)
				.setLeft(new SimpleTreePanel(SimpleTreePanel.LEFT,true))
				.setRight(new SimpleTreePanel(SimpleTreePanel.RIGHT)))
		  .setRight(new SimpleTreePanel(SimpleTreePanel.RIGHT,true)
		  	.setRight(new SimpleTreePanel(SimpleTreePanel.RIGHT))));
