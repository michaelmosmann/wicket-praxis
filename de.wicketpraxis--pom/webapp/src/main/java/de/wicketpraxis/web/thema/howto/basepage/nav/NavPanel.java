...
public class NavPanel extends Panel
{
	...
	private void initPanel(IModel<NavCallbackInterface> callbackModel)
	{
		...
		CascadingLoadableDetachableModel<String, NavCallbackInterface> classModel=new CascadingLoadableDetachableModel<String, NavCallbackInterface>(callbackModel)
		{
			@Override
		...
		Link<NavCallbackInterface> link = new Link<NavCallbackInterface>("link", callbackModel)
		{
			...
			protected void onBeforeRender()
			{
				...
				if (nameModel.getObject()==null) setVisible(false);
