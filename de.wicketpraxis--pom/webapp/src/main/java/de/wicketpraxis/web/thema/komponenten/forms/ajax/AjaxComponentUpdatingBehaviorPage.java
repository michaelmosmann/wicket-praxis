	...
	public AjaxComponentUpdatingBehaviorPage()
	{
		...
		AjaxFormComponentUpdatingBehavior ajaxBehavior = new AjaxFormComponentUpdatingBehavior("onBlur")
		{
			...
			protected void onUpdate(AjaxRequestTarget target)
			{
				...
				info("Ajax.Update: Text: "+bean.getText()+", Text2: "+bean.getText2()+" Input: "+textField.getConvertedInput());
			...
			protected void onError(AjaxRequestTarget target, RuntimeException e)
			{
				...
				StandardTypesBean bean = form.getModelObject();
				error("Ajax.Error: Text: "+bean.getText()+", Text2: "+bean.getText2()+" Input: "+textField.getConvertedInput());
				updateFeedbackPanel(target);
			}
