...
public class BootStrap extends WebPage
{
	...
	public BootStrap()
	{
		String[][] fixture = 
		{
				{ "test@wicket-praxis.de", "1234", "klaus" },
				{ "klaus@im-urlaub.de", "1234", "klaus"  },
				{ "hans@mondlandung.de", "1234", "hans"  },
				{ "alfred@in-der-kiste.com", "1234", "alfred"  },
				{ "bert@fred.de", "1234", "bert"  },
				{ "susi@sommer.net", "1234", "susi"  },
				{ "a.e@neumann.de", "1234", "alfred"  },
