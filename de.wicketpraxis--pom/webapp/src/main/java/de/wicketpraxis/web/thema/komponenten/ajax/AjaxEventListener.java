...
public class AjaxEventListener<T extends AbstractAjaxEvent> extends WebMarkupContainer implements AjaxEventListenerInterface
{
	...
	{
		if (onAjaxEvent(event)) event.update(this);
	}
