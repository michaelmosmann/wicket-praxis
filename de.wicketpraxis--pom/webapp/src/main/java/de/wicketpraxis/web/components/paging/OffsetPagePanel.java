...
public class OffsetPagePanel extends Panel {
	...
	public OffsetPagePanel(String id, IModel<Integer> offsetModel, IModel<? extends Integer> perPageModel,
			IModel<? extends Integer> sizeModel) {
		super(id);
		...
		Cascading2LoadableDetachableModel<List<Integer>, Integer, Integer> pages = new Cascading2LoadableDetachableModel<List<Integer>, Integer, Integer>(
				perPageModel, sizeModel) {
